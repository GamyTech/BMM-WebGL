...
public class AddressProofWidget : Widget
{
    ...
    {
        UserController.Instance.SendIdentityProofToServer(Enums.VerificationRank.AddressVerified, picURL);
    }
    ...
    public void UploadPictureCallback(CloudResponse response)
    {
        ...
        else
        {
            ...
            PopupController.Instance.ShowSmallPopup("Failed To Upload Picture﻿");
        }
    }
    ...
    private void OnVerifyRequest(Ack ack)
    {
        ...
        {
            PopupController.Instance.ShowSmallPopup("Request Sent", new string[] { "Your Address is going to be verified." },
    ...
    {
        AzureUploadKit.UploadTexture(ContentController.Instance, ContentType.AddressProof, pictureImage.sprite.texture, UserController.Instance.gtUser.Id, UploadPictureCallback);
    }
    #endregion Buttons
}
