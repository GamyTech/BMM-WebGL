...
{
    /// <summary>
	///   <para>The Editor for the HorizontalOrVertcalDynamicContentLayoutGroup class.</para>
	/// </summary>
	[CanEditMultipleObjects, CustomEditor(typeof(HorizontalOrVertcalDynamicContentLayoutGroup), true)]
    public class HorizontalOrVertcalDynamicContentLayoutGroupEditor : Editor
    {
