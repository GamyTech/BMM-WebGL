...
namespace AssetBundles
{
    public class AssetBundlesMenuItems
    {
        ...
        const string kUseAssetsBundle = "Assets/AssetBundles/Use Asset Bundles";

        [MenuItem(kUseAssetsBundle)]
        public static void ToggleUseAssetBundles()
        {
            AssetController.UseAssetsBundle = !AssetController.UseAssetsBundle;
        }

        [MenuItem(kUseAssetsBundle, true)]
        public static bool ToggleUseAssetBundlesValidate()
        {
            Menu.SetChecked(kUseAssetsBundle, AssetController.UseAssetsBundle);
            return true;
        }
