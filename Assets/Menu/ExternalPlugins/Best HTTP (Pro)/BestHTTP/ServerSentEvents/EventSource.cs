...
#region Privates
        ...
        public EventSource(Uri uri)
        {
            ...
            this.Id = ES_Create(this.Uri.ToString(), WithCredentials, OnOpenCallback, OnMessageCallback, OnErrorCallback, UnityEngine.Debug.isDebugBuild);
...
#region IHeartbeat Implementation
        ...
        [DllImport("__Internal")]
        static extern uint ES_Create(string url, bool withCred, OnWebGLEventSourceOpenDelegate onOpen, OnWebGLEventSourceMessageDelegate onMessage, OnWebGLEventSourceErrorDelegate onError, bool debugBuild);
