    ...
    internal sealed class WebGLConnection : ConnectionBase
    {
        ...
        protected override void ThreadFunc(object param /*null*/)
        {
            ...
            this.NativeId = XHR_Create(HTTPRequest.MethodNames[(byte)CurrentRequest.MethodType],
                                       ...
                                       CurrentRequest.Credentials != null ? CurrentRequest.Credentials.Password : null, UnityEngine.Debug.isDebugBuild);
...
#region WebGL Interface
        ...
        private static extern int XHR_Create(string method, string url, string userName, string passwd, bool debugBuild);
