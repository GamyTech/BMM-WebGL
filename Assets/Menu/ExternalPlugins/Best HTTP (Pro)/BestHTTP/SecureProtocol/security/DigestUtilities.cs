...
using HTTPOrg.BouncyCastle.Asn1.CryptoPro;
using HTTPOrg.BouncyCastle.Asn1.Nist;
using HTTPOrg.BouncyCastle.Asn1.Pkcs;
using HTTPOrg.BouncyCastle.Asn1.Oiw;
using HTTPOrg.BouncyCastle.Asn1.TeleTrust;
using HTTPOrg.BouncyCastle.Security;
using HTTPOrg.BouncyCastle.Crypto.Digests;
using HTTPOrg.BouncyCastle.Crypto;
using HTTPOrg.BouncyCastle.Utilities;

namespace HTTPOrg.BouncyCastle.Security
{
    /// <remarks>
    ...
    public sealed class DigestUtilities
    {
        ...
        static DigestUtilities()
        {
            ...
            ((DigestAlgorithm)HTTPOrg.BouncyCastle.Utilities.Enums.GetArbitraryValue(typeof(DigestAlgorithm))).ToString();
...
//			algorithms[TeleTrusTObjectIdentifiers.RipeMD320.Id] = "RIPEMD320";
            ...
            string algorithm)
        {
            ...
            try
            {
                DigestAlgorithm digestAlgorithm = (DigestAlgorithm)HTTPOrg.BouncyCastle.Utilities.Enums.GetEnumValue(
