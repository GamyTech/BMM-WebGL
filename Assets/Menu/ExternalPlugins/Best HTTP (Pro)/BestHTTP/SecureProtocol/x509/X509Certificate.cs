...
using HTTPOrg.BouncyCastle.Asn1.Misc;
using HTTPOrg.BouncyCastle.Asn1.Utilities;
using HTTPOrg.BouncyCastle.Asn1.X509;
using HTTPOrg.BouncyCastle.Crypto;
using HTTPOrg.BouncyCastle.Math;
using HTTPOrg.BouncyCastle.Security;
using HTTPOrg.BouncyCastle.Security.Certificates;
using HTTPOrg.BouncyCastle.Utilities;
using HTTPOrg.BouncyCastle.Utilities.Encoders;
using HTTPOrg.BouncyCastle.X509.Extension;
using HTTPOrg.BouncyCastle.Crypto.Operators;

namespace HTTPOrg.BouncyCastle.X509
{
    /// <summary>
...
//        }
		...
		/// <summary>
        /// Return a <see cref="HTTPOrg.BouncyCastle.Math.BigInteger">BigInteger</see> containing the serial number.
        /// </summary>
