...
namespace I2.Loc
{
	public static class LocalizationManager
	{
		...
		public static bool TryGetTermTranslation(string Term, out string Translation, bool FixForRTL = false, int maxLineLengthForRTL = 0)
		{
		...
		public static string ApplyRTLfix( string line, int maxCharacters = 0 )
		{
			if (maxCharacters <= 0)
		...
		{
            Debug.Log("Upadting localization");
